...
public class Controlling extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDevice = b.getParcelable(connect_with_arduino.DEVICE_EXTRA);
        mDeviceUUID = UUID.fromString(b.getString(connect_with_arduino.DEVICE_UUID));
        mMaxChars = b.getInt(connect_with_arduino.BUFFER_SIZE);
